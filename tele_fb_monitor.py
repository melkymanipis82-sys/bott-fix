...
OWNER_IDS_SEED = parse_ids(os.getenv("OWNER_IDS", ""))
...
def main():
    ...
    application.add_handler(CommandHandler(["help", "trogiup"], help_cmd))
    ...
    add_conversation = ConversationHandler(
        entry_points=[CommandHandler(["add", "them"], add_entry)],
        states={
    ...
    application.add_handler(CommandHandler(["list", "danhsach"], list_cmd))
    application.add_handler(CommandHandler(["remove", "xoa"], remove_cmd))
